...
async function ensureSchema() {
  // Production best practice is migrations.
  // This guard lets you temporarily auto-create in production if needed:
  // set ALLOW_SCHEMA_AUTO_CREATE=true in Vercel env once, deploy, then remove.
...
export default async function handler(req, res) {
  ...
  // Auth required for all non-OPTIONS
